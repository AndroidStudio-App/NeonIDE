package com.termux.view.treeview.model;
...
import com.termux.view.treeview.view.TreeNodeWrapperView;
...
public class TreeNode {
     ...
     * Useful for refreshing dynamically generated trees (e.g. file explorers).
     */
    ...
    public static abstract class BaseNodeViewHolder<E> {
        ...
        /**
         * Clear cached view so that {@link #getView()} recreates it.
         * Useful for dynamic UI changes (e.g. file tree row scaling).
         */
        ...
        /**
         * @return The cached view for this node if it was already created, otherwise null.
         */
