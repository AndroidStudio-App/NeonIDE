...
1. Add the configuration and language grammar from [textmate-grammar](https://github.com/shikijs/textmate-grammars-themes/tree/main/packages/tm-grammars) in to the texmate/assets folder 
